...
void setup()
{
  ...
  pic2 = loadImage("../Images/PXL_20220815_182722808.jpg");
  //pic3 = loadImage("");
  ...
  if ( nightMode == false ) tint(0, 480, 0); //Gray Scale: use 1/2 tint value for white (i.e. 128/256=1/2)
...
void mousePressed() {
  ...
  if (mouseButton == LEFT) {
    nightMode = false;
    rect( backgroundImageX, backgroundImageY, backgroundImageWidth, backgroundImageHeight );
    tint(0,8,0); //Gray Scale: use 1/2 tint value for white (i.e. 128/256=1/2)
    image( pic, backgroundImageX, backgroundImageY, picWidthAdjusted, picHeightAdjusted);
    //
  }
